package com.example.kbl.githubappcopy.view.divider;
...
public class DividerRepositories extends RecyclerView.ItemDecoration {
    ...
    public DividerRepositories(Drawable divider) {
        mDivider = divider;
    }

    public DividerRepositories(Drawable divider, boolean showFirstDivider,
